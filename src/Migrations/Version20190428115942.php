 ...
 */
final class Version20190428115942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE support ADD name VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE support DROP name, DROP description, DROP type');
